    ...
    <section id="pricing" className="py-20 md:py-32 bg-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            {data?.eyebrow || '💎 Simple, Transparent Pricing'}
          </div>
          ...
          >
            {data?.heading || 'Choose the Perfect Plan'}
          </h2>
          ...
          >
            {data?.subheading || 'Start free, upgrade as you grow. All plans include 14-day free trial.'}
          </p>
        </motion.div>
